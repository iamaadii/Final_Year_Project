...
export async function POST(req) {
  ...
  try {
    ...
    invoice.status = fullySettled || nextPaid / totalAmount > 0.999 ? "Paid" : "Partially Settled";
    ...
    return errorResponse("INTERNAL_ERROR", "Failed to process payment link reconciliation", 500, requestId);
  }
}
