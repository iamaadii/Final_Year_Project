...
export default async function SellerDashboardRedirectPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-[#eef3f8] px-4 py-10 sm:px-6">
      <div className="mx-auto w-full max-w-3xl rounded-2xl bg-white p-6 shadow sm:p-8">
        <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Seller Dashboard Route</p>
        <h1 className="mt-2 text-3xl font-bold text-slate-900 sm:text-4xl">{breadcrumb}</h1>
        <p className="mt-4 text-slate-600">
          You were redirected successfully from a clickable seller dashboard item.
        </p>
        <div className="mt-8">
          <Link
