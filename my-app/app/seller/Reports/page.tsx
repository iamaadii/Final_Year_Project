...
const TABS: Tab[] = [
  ...
  { key: "aging", label: "AR Aging", type: "aging" },
];
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      <header className="rounded-3xl border border-slate-200/60 bg-white/70 backdrop-blur-xl p-6 shadow-sm">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500 font-medium">Profit & Loss, Balance Sheet, Cash Flow, and AR Aging reports.</p>
          </div>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        {!loading && reportData.kind === "aging" && (
          <div className="p-6 space-y-6">
            <h2 className="text-xl font-black text-slate-800">{reportData.report || "AR Aging"}</h2>
